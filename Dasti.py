...
except:ugen = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] SHAHBAZ
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] SHAHBAZ
...
\x1b[92;1m╔════════════════════════════════════════╗
[•] Author: SHAHBAZ DASTII
[•] Facebook: facebook.com/DASTII 790
[•] Github: github.com/SHAHBAZ-009
[•] Tools: FILE CRACKER
...
def menu(): #DASTI
	...
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	SHAHBAZ= input(x+'\33[1;96m•Input Number> ')
	if SHAHBAZin ['1','01']:
		File2()
	elif SHAHBAZin ['0','00']:
		exit()
